    ...
    <#elseif section = "form">
        ...
        <form id="kc-register-form" class="form-container" action="${url.registrationAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('phone',properties.kcFormGroupErrorClass!)}">
                <div class="label-register">
                    <label for="user.attributes.dob" class="${properties.kcLabelClass!}">${msg("Numero di telefono")}</label>
                </div>
                    <input type="text" id="user.attributes.dob" class="input-register" placeholder="${msg("Numero di telefono")}" name="user.attributes.dob"
                           value="${(register.formData['user.attributes.phone']!'')}" aria-invalid="<#if messagesPerField.existsError('phone')>true</#if>">
            ...
            <#if !realm.registrationEmailAsUsername>
                <div class=" ${messagesPerField.printIfExists('username',properties.kcFormGroupErrorClass!)}">
                    <div class=label-register">
                        ...
                        <input type="text" id="username" class="input-register" placeholder="${msg("Username")}" name="username" value="${(register.formData.username!'')}" autocomplete="username" />
                </div>
            </#if>
